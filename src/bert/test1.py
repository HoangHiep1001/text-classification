...
class ROBERTAClassifier(torch.nn.Module):
    def __init__(self, num_labels, bert_model, dropout_rate=0.5):
...
class ClassifierTrainner():
    def __init__(self, bert_model, train_dataloader, valid_dataloader, epochs=10, cuda_device="cpu", save_dir=None):
        ...
        if save_dir is not None and os.path.exists(save_dir):
            ...
            self.save_dir = '../content/drive/MyDrive/project/data/'+datetime.now().strftime("%d-%m-%Y_%H-%M-%S")
    ...
    def train_classifier(self):
        ...
        for epoch_i in range(0, self.epochs):
            ...
            torch.save(self.model.state_dict(),"../content/drive/MyDrive/project/model_bert.pth")
            self.model.eval()
            ...
            if best_eval_accuracy > eval_accuracy:
                ...
                print('debug============',best_eval_accuracy_path)
                self.save_checkpoint(best_eval_accuracy_path)
            # torch.save(self.model.state_dict(), '../content/drive/MyDrive/project/data/')
