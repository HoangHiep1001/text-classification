...
if __name__ == '__main__':
    ...
    # le.fit(['bat_dong_san.txt','cong_nghe','dien_anh','du_lich','game','giao_duc','kinh_doanh','ngan_hang','suc_khoe','the_thao','thoi_su_phap_thuat'])
    le.fit(['bat_dong_san.txt','dien_anh'])
    print(label)
